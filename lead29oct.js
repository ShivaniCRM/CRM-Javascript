...
function SHOWHideSCA(executionContext)
{
    ...
    else if (leadtype == 100000001 || leadtype ==100000002 || leadtype== 100000003) {
        return false;
    }
...
function SHOWHideAD(formContext) {
    ...
    if (statuscode == 100000004 || statuscode == 100000003 ) {
        return false;
    }
    else if (leadtype == 100000000) {
    ...
    Xrm.WebApi.retrieveRecord("systemuser", userId, "?$expand=systemuserroles_association($select=name)").then(
        function success(result) {
            ...
            for (var i = 0; i < result.systemuserroles_association.length; i++) {
                ...
                else if (roleName == "SR" && statuscode == 100000002 || roleName == "RTM" && statuscode == 100000004) {
                    isButtonEnabled = true;
                }
